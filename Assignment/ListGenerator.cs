...
namespace Assignment
{
    internal static class ListGenerator
    {
        ...
        static ListGenerator()
        {
            ...
            //CustomerList = XDocument.Load("C: \\Users\\Windows 10\\OneDrive\\Desktop\\Data - 20240820T224257Z - 001\\Customer.Xml");
            CustomerList = (from e in XDocument.Load("Customers.xml").Root.Elements("customer") //XML File
                            select new Customer()
                            {
            ...
            Words = File.ReadAllLines("C:\\Users\\Windows 10\\source\\repos\\AssignmentLINQ01\\Assignment\\bin\\Debug\\net8.0\\dictionary_english.txt");
